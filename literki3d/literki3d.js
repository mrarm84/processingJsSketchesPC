...
function keyPressed() {
  ...
  const paletteNames = ['Giftcard_sub', 'Another1', 'Another2', 'Another3', 'Another4', 'Another5', 'Another6', 'Another7', 'Another8', 'Another9'];
  
  const keyIndex = paletteKeys.indexOf(key);
  if (keyIndex !== -1) {
    const orgPalette = getColorScheme(paletteNames[keyIndex]);
    palette = repeatPalette(orgPalette, 1);
  }
}
